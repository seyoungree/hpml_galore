...
def parse_args(args):
    ...
    parser.add_argument("--proj_quantize_type", type=str, default='8bit_blockwise', choices=["4bit", "8bit", "8bit_blockwise"],
...
def main(args):
    ...
    if 'galore' in args.optimizer.lower():
        ...
        param_groups = [{'params': regular_params}, 
                        {'params': galore_params, 'rank': args.rank, 'update_proj_gap': args.update_proj_gap, 'scale': args.galore_scale,
                         'proj_type': args.proj_type, 'proj_quantize_type': args.proj_quantize_type, 'proj_quantize_blocksz': args.proj_quantize_blocksz}]
